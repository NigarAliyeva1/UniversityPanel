...
namespace MyProjectUniversityPanel.Migrations
{
    ...
    [Migration("20221217184534_CreateDesignationsTable")]
    partial class CreateDesignationsTable
    {
            ...
            modelBuilder.Entity("MyProjectUniversityPanel.Models.Kassa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedFor = "",
                            LastModifiedMoney = 0,
                            LastModifiedTime = new DateTime(2022, 12, 17, 22, 45, 30, 960, DateTimeKind.Utc).AddTicks(7501)
                        });
                });
