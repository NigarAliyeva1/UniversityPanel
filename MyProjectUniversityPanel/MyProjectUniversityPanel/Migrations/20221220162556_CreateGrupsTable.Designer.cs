...
namespace MyProjectUniversityPanel.Migrations
{
    ...
    [Migration("20221220162556_CreateGrupsTable")]
    partial class CreateGrupsTable
    {
            ...
            modelBuilder.Entity("MyProjectUniversityPanel.Models.Kassa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedFor = "",
                            LastModifiedMoney = 0,
                            LastModifiedTime = new DateTime(2022, 12, 20, 20, 25, 55, 350, DateTimeKind.Utc).AddTicks(1855)
                        });
                });
