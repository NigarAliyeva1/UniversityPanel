...
namespace MyProjectUniversityPanel.Migrations
{
    ...
    [Migration("20221220053647_RemoveColumnFromEmailTable")]
    partial class RemoveColumnFromEmailTable
    {
            ...
            modelBuilder.Entity("MyProjectUniversityPanel.Models.Kassa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedFor = "",
                            LastModifiedMoney = 0,
                            LastModifiedTime = new DateTime(2022, 12, 20, 9, 36, 46, 463, DateTimeKind.Utc).AddTicks(3931)
                        });
                });
